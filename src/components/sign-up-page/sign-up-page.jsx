    ...
    <div className={classes['sign-up__wrapper']}>
      <form action={() => {}} onSubmit={handleSubmit(onSubmit)}>
        ...
        <p>
          <b>Username</b>
          <br />
          <input className={classes['sign-up__textfield']} type="text" size="40" placeholder="Username"
                 name='username'
        ...
        <p>
          <b>Email address</b>
          <br />
          <input className={classes['sign-up__textfield']}
                 type="email" size="40"
        ...
        <p>
          ...
          {_.get('password.type', errors) === 'minLength' && <p style={{ color: 'red' }}>Password must have at least 8 characters</p>}
        </p>
        <p>
          <b>Repeat Password</b>
          <br />
          ...
          {_.get('password_repeat.type', errors) === 'validate' && <p style={{ color: 'red' }}>The passwords do not match</p>}
        </p>
        <hr />
